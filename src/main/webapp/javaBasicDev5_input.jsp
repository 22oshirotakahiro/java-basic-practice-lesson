...
<body>
	...
	<form action="javaBasicDev5_result.jsp" method="post">
		<table>
			...
			<tr>
				<td><input type="text" class="product" name="product1">
				</td>
				<td><input type="number" min="1" max="100000" class="amount"
					name="amount1"></td>
			</tr>
			<tr>
				<td><input type="text" class="product" name="product2">
				</td>
				<td><input type="number" min="1" max="100000" class="amount"
					name="amount2"></td>
			</tr>
		...
		<p>
			<label>ランク：</label> <select name="rank">
